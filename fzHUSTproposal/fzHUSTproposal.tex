%%
%% This is the file `fzHUSTproposal.tex' designed for the undergraduate thesis proposal task at Huazhong University of Science and Technology. 
%% 
%% 
...
%% 
%% Aiming to reach more friends, this work directly and only contains the fzHUSTproposal.tex. And I have carefully included all the settings according to the offical documents and explaination after each command line.

%% This file should compiled with XeLaTex. The edit sorftware TexStudio is recommended by zhou.

%% Btw: My operating system is windows and this file has been tested successfully at my computer(win10). For other OSs like linux or mac, you should find someone else, hahaha! Be aware that my purpose is to provide a friendly latex template for myself or maybe other HUSTers, so the only thing you need to do before you start your own work is to imitate the example tex file, fzHUSTproposal.tex. Good luck!
