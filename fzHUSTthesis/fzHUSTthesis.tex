%%
%% This is the file `fzHUSTthesis.tex' designed for the undergraduate thesis at Huazhong University of Science and Technology. 
%% 
%% 
...
%% 
%% Aiming to reach more friends, this work directly and only contains the fzHUSTthesis.tex. And I have carefully included all the settings according to the offical documents and explaination after each command line.
...
%% For the styles of sections at all levels
 ...
 \usepackage{titletoc}
 \titleformat{\section}{
 	 \centering \hei \bfseries\xiaoerhao}{\thesection}{1em}{} %在section标题编号后面加个点
...
\usepackage{wasysym}
%制作tatement中的符号
\def\fzHUSTcheckedbox{$\Square\!\!\!\!\checkmark$}
\def\fzHUSTbox{$\Square$}
%设置命令
\newcommand{\statement}[2]{
	\def\yearofconfidentiality{\hspace{2em}}

    \def\fzHUSTconfidential{\fzHUSTbox}
	\def\fzHUSTnotconfidential{\fzHUSTcheckedbox}
	\ifnum #1<2
		\def\fzHUSTconfidential{\fzHUSTcheckedbox}
		\def\fzHUSTnotconfidential{\fzHUSTbox}
    ...
    本学位论文属于 1、保密 \fzHUSTconfidential ，在 \yearofconfidentiality 年解密后适用本授权书。
			
		    \hspace{7em} 2、不保密 \fzHUSTnotconfidential \hspace{1em}
			。
...
%			
			...
			{\sanhao \hwzs 
				...
				\begin{tabular}{lc}
					...
					\underline{\makebox[\fzHUSTtitlelength]{\school}} \\
					\makebox[4em][s]{专业班级} &
					\underline{\makebox[\fzHUSTtitlelength]{\classnum}} \\
					\makebox[4em][s]{姓 \hfill 名} &
					\underline{\makebox[\fzHUSTtitlelength]{\theauthor}} \\
					\makebox[4em][s]{学 \hfill 号} &
					\underline{\makebox[\fzHUSTtitlelength]{\stunum}} \\
					\makebox[4em][s]{指导教师} &
					\underline{\makebox[\fzHUSTtitlelength]{\instructor}} \\
			  \end{tabular}
		    }
...
\begin{description}
	\seccontent
	\item[基本信息] 作者：冯洲 \href{mailto:fengzhou1113@gmail.com}{fengzhou1113@gmail.com}. 版本信息：2019/3/1, v1.0发布在 \url{https://github.com/frenzy666}。 如果有任何建议及纠正，欢迎邮件联系作者，非常感谢！
...
%-------------------------参考文献----------------------------------%
	...
	\bibliography{fzHUSTthesisRef}\label{bibtexref}
