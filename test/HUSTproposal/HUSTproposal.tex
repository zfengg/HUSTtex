%%
%% This is the file `HUSTproposal.tex' designed for the undergraduate thesis proposal task at Huazhong University of Science and Technology. 
%% 
%% 
...
%% Btw: Be aware that my purpose is to provide a friendly latex template for myself or maybe other HUSTers, so the only thing you need to do before you start your own work is to imitate the example tex file, fzHUSTproposal.tex. Good luck!
